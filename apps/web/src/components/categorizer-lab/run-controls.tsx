      ...
      <div className="space-y-6">
            ...
            {options.mode === 'hybrid' && (
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => handleOptionChange('hybridThreshold', parseFloat(e.target.value))}
                  disabled={isRunning}
                />
                <p className="text-sm text-gray-500 mt-1">
        ...
        {estimates && (
          <div>
            ...
            <div className="grid grid-cols-4 gap-4">
              ...
              <div className="text-center">
                <div className="text-2xl font-bold text-green-600">{estimates.estimatedTimeSeconds}s</div>
                <div className="text-sm text-gray-500">Est. Time</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-purple-600">{estimates.estimatedLLMCalls}</div>
                <div className="text-sm text-gray-500">LLM Calls</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-orange-600">${estimates.estimatedCostUSD.toFixed(3)}</div>
        ...
        <div className="text-sm text-gray-500">
          ...
          <ul className="list-disc list-inside mt-1 space-y-1">
            <li><strong>Pass-1:</strong> Fast rule-based matching using MCCs, vendor patterns, and heuristics</li>
            <li><strong>Pass-2:</strong> LLM-powered categorization for complex or ambiguous transactions</li>
            <li><strong>Hybrid:</strong> Use Pass-1 first, fall back to Pass-2 for low-confidence results</li>
          </ul>
        </div>
      </div>
    </Card>
